...
{
public:
    using SharedPtr = std::shared_ptr<AccelerationStructureBuilder>;

    static SharedPtr Create(Buffer::SharedPtr pBoundingBoxBuffer, uint boxCount);

    void BuildAS(RenderContext* pContext, uint32_t rayTypeCount);
